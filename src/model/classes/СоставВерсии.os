...
Функция ПолучитьМанифест()
	...
	МанифестПоискаФайлов.СоздатьДистрибутив("zip", "Zip-архив")
		...
		.ДобавитьФайл(Архитектуры.Арх86, "", "*-fdd-x86.zip") // для совместимости с ovm install dev
	...
	МанифестПоискаФайлов.СоздатьДистрибутив("osx-x64", "Независимый дистрибутив (MacOS Intel)")
		.ДобавитьФайл(Архитектуры.Арх86, "", "*-osx-x64.zip")
		.ДобавитьФайл(Архитектуры.Арх64, "", "*-osx-x64.zip");

	МанифестПоискаФайлов.СоздатьДистрибутив("osx-arm64", "Независимый дистрибутив (Mac OS ARM)")
		.ДобавитьФайл(Архитектуры.Арх86, "", "*-osx-arm64.zip")
		.ДобавитьФайл(Архитектуры.Арх64, "", "*-osx-arm64.zip");
