...
Функция ПолучитьСодержимоеСтраницыКонтента(Знач ИдентификаторСекции, Знач ИдентификаторСтраницы) Экспорт
	...
	Иначе
		...
		//Сообщить("Идентификатор секции: " + ИдентификаторСекции);

		ЭтоMD = Истина;
		ИдентификаторСтраницы = СтрЗаменить(ИдентификаторСтраницы, "-", "");
...
Функция ПолучитьПутьККонтентуMD(ИдентификаторСекции, ИдентификаторСтраницы)
	...
	Если ИдентификаторСекции = "syntax" Тогда 
		ПутьКФайлу = ОбъединитьПути(Каталог, "markdown", ИдентификаторСекции, ИдентификаторСтраницы + ".md"); 
